...
// Methods of the page
  ...
  Future<bool> _createTask(
      String id, String taskname, String additionaldetails) async {
    try {
                  ...
                  children: [
                    ...
                    RoundedButton(
                      child: ElevatedButton(
                        onPressed: () async {
                          await _wishlist.doc(documentSnapshot!.id).update({
            ...
            child: Column(
              ...
              children: [
                ...
                RoundedButton(
                    child: ElevatedButton(
                        onPressed: () async {
                          bool isSuccess = await _createTask(currentUserID,
                              _taskname.text, _additionaldetails.text);
                          if (isSuccess) {
                            ...
                            return Column(
                              children: [
                                ListTile(
                                  ...
                                  subtitle: Text(
                                    documentSnapshot['additionalDetails'],
                                    style: const TextStyle(
                                      color: Color(0xFFF7EEC9),
                                    ),
                                  ),
